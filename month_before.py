...
with open('launches_past_month.csv', mode='w', newline='') as file:
...
while next_url:
    ...
    with open('C:\\Users\\standalone1\\Desktop\\Rocketlaunch\\Output\\launches_previous_month.csv', mode='a', newline='') as file:
        writer = csv.writer(file)
